 ...
 */
public class EdgesXML extends XMLElement{

    public static final String TAG_NAME = "edges";
    ...
    public EdgesXML(String value) throws Exception{
        super(value);
    ...
    public void addEdge(EdgeXML edge){
        this.root.addContent(edge.asJDomElement());
    }
